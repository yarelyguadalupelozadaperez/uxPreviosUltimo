     ...
     onTextFieldChange: function() {
         ...
         if (me.searchValue !== null) {
             ...
             if (count) {
                ...
                me.gotoCurrent();
                me.statusBar.setStatus({
                	text: Ext.String.format(Ext.SistemasCasa.LiveSearchGrid.MATCHES, count, count === 1 ? '' : Ext.SistemasCasa.LiveSearchGrid.END_PLURAL),
