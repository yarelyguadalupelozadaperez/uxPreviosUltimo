...
Ext.define("Ext.ux.SistemasCasa.controller.Controller2022",{
	...
	init	: function() {
		var me = this,
            ...
            me.control({
                ...
                "viewport2022 tabpanel grid textfield": {
	 ...
	 */
        updatedate      :function(){
            var me = this;
            var tabPanel = this.win.down("viewport2022 tabpanel");
	...
	remove		: function (){
            var me = this;
             var tabPanel = me.win.down("viewport2022 tabpanel"),
                grid = tabPanel.getActiveTab(),            
                store = grid.getStore();
        ...
        filter          : function () {
            ...
            if(fields.value > 0 && text == undefined) {
    ...
    massiveupdate: function () {
        ...
        excel           : function () {
            ...
            var file = Ext.getCmp("idTariffPrincipal2022").valueModels[0].raw[1] + '_' + tabPanel.activeTab.title;
