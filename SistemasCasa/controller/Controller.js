...
Ext.define("Ext.ux.SistemasCasa.controller.Controller",{
	...
	init	: function() {
		var me = this,
            ...
            me.control({
                ...
                "viewport tabpanel grid textfield": {
	 ...
	 */
        updatedate      :function(){
            var me = this;
            var tabPanel = this.win.down("viewport tabpanel");
	...
	remove		: function (){
            var me = this;
             var tabPanel = me.win.down("viewport tabpanel"),
                grid = tabPanel.getActiveTab(),            
                store = grid.getStore();
    ...
    massiveupdate: function () {
        ...
        excel           : function () {
            ...
            var file = Ext.getCmp("idTariffPrincipal").valueModels[0].raw[1] + '_' + tabPanel.activeTab.title;
