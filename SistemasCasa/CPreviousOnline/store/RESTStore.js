...
Ext.define("Ext.ux.SistemasCasa.CPreviousOnline.store.RESTStore", {
    ...
    listeners: {
        write: function (store, operation) {
            ...
            if (this.storeId == "CPreviousOnline.catalogs.administrator.users.store.Importers") {
                this.load();
            } else if (this.storeId == "CpreviosOnline.catalogs.administrator.users.store.Users") {
                this.load();
          } 
        },
